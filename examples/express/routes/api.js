...
router.get('/agenciesNearby/:lat/:lon/:radiusInMiles', function(req, res){
...
router.get('/agenciesNearby/:lat/:lon', function(req, res){
  var lat = req.params.lat,
  lon = req.params.lon;
...
/* Routelist */
router.get('/routes/:agency', function(req, res){
...
router.get('/routesNearby/:lat/:lon/:radiusInMiles', function(req, res){
  var lat = req.params.lat,
  lon = req.params.lon,
  radius = req.params.radiusInMiles;
...
router.get('/routesNearby/:lat/:lon', function(req, res){
  var lat = req.params.lat,
  lon = req.params.lon;
...
/* Shapes */
router.get('/shapes/:agency/:route_id/:direction_id', function(req, res){
  var agency_key = req.params.agency,
...
router.get('/shapes/:agency/:route_id', function(req, res){
  var agency_key = req.params.agency,
  route_id = req.params.route_id
...
/* Stoplist */
router.get('/stops/:agency/:route_id/:direction_id', function(req, res){
  var agency_key = req.params.agency,
  route_id = req.params.route_id,
  direction_id = parseInt(req.params.direction_id,10);
...
router.get('/stops/:agency/:route_id', function(req, res){
  var agency_key = req.params.agency,
  route_id = req.params.route_id;
...
router.get('/stopsNearby/:lat/:lon/:radiusInMiles', function(req, res){
  var lat = req.params.lat
  lon = req.params.lon
  radius = req.params.radiusInMiles;
...
router.get('/stopsNearby/:lat/:lon', function(req, res){
  var lat = req.params.lat,
  lon = req.params.lon;
...
/* Times */
router.get('/times/:agency/:route_id/:stop_id/:direction_id', function(req, res){
  var agency_key = req.params.agency,
  route_id = req.params.route_id,
...
router.get('/times/:agency/:route_id/:stop_id', function(req, res){
  var agency_key = req.params.agency,
  route_id = req.params.route_id,
  stop_id = req.params.stop_id;
