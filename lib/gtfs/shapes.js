...
/*
 * Returns array of shapes that match the query parameters. A `route_id` query parameter may be passed to find all shapes for a route. A `trip_id` query parameter may be passed to find all shapes for a trip. A `direction_id` query parameter may be passed to find all shapes for a direction.
 */
