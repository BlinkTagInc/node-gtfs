 ...
 * endDate
 */
exports.getCalendars = (agencyKey, startDate, endDate, monday, tuesday, wednesday, thursday, friday, saturday, sunday, cb) => {
  const daysOfWeek = [];
  let daysOfWeekQuery;
 ...
 */
exports.getCalendarsByService = (serviceIds, cb) => {
