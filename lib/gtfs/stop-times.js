 ...
 */
exports.getStoptimes = async (query = {}, projection = '-_id -created_at', options = {lean: true, sort: {stop_sequence: 1}, timeout: true}) => {
  ...
  if (query.trip_id === undefined) {
    ...
    const tripIds = await Trip.find(tripQuery, {}, {timeout: true}).distinct('trip_id');
