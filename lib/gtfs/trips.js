 ...
 */
exports.getTripsByRouteAndDirection = (agencyKey, routeId, direction_id, service_ids, cb) => {
 ...
 */
exports.getDirectionsByRoute = (agencyKey, routeId, service_ids, cb) => {
  if (_.isFunction(service_ids)) {
    cb = service_ids;
    service_ids = undefined;
  }
  ...
  .then(directions => cb ? cb(null, directions) : directions)
  .catch(cb);
};
