...
require('../models/TimetablePage');
require('../models/TimetableStopOrder');


const Agency = db.model('Agency');
const Calendar = db.model('Calendar');
const CalendarDate = db.model('CalendarDate');
const FeedInfo = db.model('FeedInfo');
const Route = db.model('Route');
const Shape = db.model('Shape');
const Stop = db.model('Stop');
const StopTime = db.model('StopTime');
const Trip = db.model('Trip');
const Timetable = db.model('Timetable');
const TimetablePage = db.model('TimetablePage');
const TimetableStopOrder = db.model('TimetableStopOrder');
