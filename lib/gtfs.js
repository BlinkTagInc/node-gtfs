...
const { getRoutes, getRoutesByIds } = require('./gtfs/routes');
const { getShapes, getShapesAsGeoJSON } = require('./gtfs/shapes');
const { getStops, getStopsAsGeoJSON, getStop } = require('./gtfs/stops');
const { getStoptimes } = require('./gtfs/stop-times');
const { getTransfers } = require('./gtfs/transfers');
const { getTrips, getDirectionsByRoute, getTripsByStopId } = require('./gtfs/trips');
...
exports.getRoutesByIds = getRoutesByIds;
...
exports.getTripsByStopId = getTripsByStopId;
