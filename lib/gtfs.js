...
module.exports = {
  ...
  */
  getRoute: function(route_id, cb) {
    Route.findOne({route_id: route_id}, cb);
  },
  ...
  */
  getStops: function(stop_ids, cb) {
    ...
    Stop.find({stop_id: {$in: stop_ids}}, cb);
  },
  ...
  */
  getStoptimesByTrip: function(trip_id, cb) {
    StopTime.find({trip_id: trip_id}, cb);
  },
  ...
  */
  getCalendarsByService: function(service_ids, cb) {
    ...
    Calendar.find({service_id: {$in: service_ids}}, cb);
  },
  ...
  */
  getCalendarDatesByService: function(service_ids, cb) {
    ...
    CalendarDate.find({service_id: {$in: service_ids}}, cb);
  }
};
