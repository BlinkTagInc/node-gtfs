...
module.exports = {
  ...
  getAgency: function(agency_key, cb){
    Agency.findOne({ agency_key: agency_key }, cb);
  },
   ...
   */
  getTripsByRouteAndDirection: function (agency_key, route_id, direction_id, cb) {
    var query = {
      agency_key: agency_key,
      route_id: route_id
    };
  ...
  getCoordinatesByRoute: function(agency_key, route_id, cb) {
    ...
    module.exports.getShapesByRoute(agency_key, route_id, function(err, shapes) {
      if (err) {
        ...
        Trip.find({ agency_key: agency_key, route_id: route_id })
        ...
        function findStop(stopData, callback) {
          Stop.findOne({ stop_id: stopData.stop_id })
      ...
      shapes.forEach(function(shape) {
        shape.sort(function(a, b) { return a.shape_pt_sequence - b.shape_pt_sequence });
        var line = shape.map(function(shape_pt) { return shape_pt.loc });
