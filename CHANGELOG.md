...
### Added
- Added agency_id to service alert informed entities 
...
### Added
- New option `fillEmptyAgencyId` to fill empty `agency_id` on routes, fares, and other files for single-agency feeds
...
### Added
- New fields in trips.txt - `safe_duration_factor` and `safe_duration_offset`
