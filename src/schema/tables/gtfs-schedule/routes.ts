...
export const routes = defineGtfsTable({
  ...
  fields: {
    ...
    route_short_name: { kind: 'text', caseInsensitiveComparison: true },
    route_long_name: { kind: 'text', caseInsensitiveComparison: true },
    ...
    network_id: { kind: 'id', applyFeedPrefix: true },
